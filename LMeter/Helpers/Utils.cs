...
namespace LMeter.Helpers
{
    public static class Utils
    {
        ...
        public static Vector2 GetTopLeft(Vector2 anchorPoint, Vector2 textBoxSize, DrawAnchor anchor) =>
            anchor switch
            {
        ...
        public static DrawAnchor Opposite(this DrawAnchor anchor) =>
            anchor switch
            {
        ...
        public static Vector2 GetTextPos(
            Vector2 parentPos,
            Vector2 parentSize,
            Vector2 textSize,
            DrawAnchor textAlignment
        )
        {
            return GetAnchoredPosition(
                GetAnchoredPosition(parentPos, -parentSize, textAlignment),
                textSize,
                textAlignment
            );
        }
